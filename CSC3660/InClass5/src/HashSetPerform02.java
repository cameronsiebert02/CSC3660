...
public class HashSetPerform02 {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("--- Hash Set: Member test time:" +
                    getTestTime(set1) + " milliseconds");
            System.out.println("--- Hash Set: Remove element time:" +
                    getRemoveTime(set1) + " milliseconds");

            // Create a linked hash set, and test its performance
            Collection<Integer> set2 = new LinkedHashSet<>(list);
            System.out.println("--- Linked Hash Set: Member test time for linked hash set is " +
            ...
            System.out.println("---- Tree Set  - Member test time: " +
                    getTestTime(set3) + " milliseconds");
            System.out.println("--- Tree Set - Remove element time: " +
